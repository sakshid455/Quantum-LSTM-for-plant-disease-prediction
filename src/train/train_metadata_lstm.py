...
for epoch in range(EPOCHS):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(
            model.state_dict(),
            "checkpoints/best_metadata_lstm.pth"
        )
...
history.to_csv(
    "outputs/metadata_lstm_loss_history.csv",
    index=False
)
...
with open(
    "outputs/metadata_lstm_test_metrics.json",
    "w"
) as f:
...
print("\n" + "=" * 60)
print("FINAL METADATA LSTM TEST RESULTS")
print("=" * 60)
